...
public class TSMultiToolsClient {
    ...
    private void onClientSetup(FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            ItemProperties.register(ModItems.SLIME.get(), ResourceLocation.withDefaultNamespace("pulling"),
                    (stack, level, entity, seed) -> entity != null && entity.isUsingItem() && entity.getUseItem() == stack ? 1.0F : 0.0F);
            ItemProperties.register(ModItems.SLIME.get(), ResourceLocation.withDefaultNamespace("pull"),
