...
public class SlimeArrowEntity extends AbstractArrow {
    ...
    public SlimeArrowEntity(final Level level, final double x, final double y, final double z, final ItemStack pickupItemStack, @Nullable final ItemStack firedFromWeapon) {
        super(ModEntitiesCommon.SLIME_ARROW, x, y, z, level, pickupItemStack, firedFromWeapon);
        this.updateColor();
        this.pickup = AbstractArrow.Pickup.CREATIVE_ONLY;
    }
    ...
    public SlimeArrowEntity(final Level level, final LivingEntity owner, final ItemStack pickupItemStack, @Nullable final ItemStack firedFromWeapon) {
        super(ModEntitiesCommon.SLIME_ARROW, owner, level, pickupItemStack, firedFromWeapon);
        this.updateColor();
        this.pickup = AbstractArrow.Pickup.CREATIVE_ONLY;
    }
    ...
    public void tick() {
        ...
        } else if (this.inGround && this.inGroundTime != 0 && !this.getPotionContents().equals(PotionContents.EMPTY) && this.inGroundTime >= EXPOSED_POTION_DECAY_TIME) {
    ...
    protected void doPostHurtEffects(final LivingEntity mob) {
        ...
        PotionContents potionContents = this.getPotionContents();
        potionContents.forEachEffect(effect -> mob.addEffect(effect, effectSource));
    }
