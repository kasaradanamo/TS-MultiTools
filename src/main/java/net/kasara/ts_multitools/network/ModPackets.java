...
public class ModPackets {
    ...
    private static void onRegisterPayloads(RegisterPayloadHandlersEvent event) {
        ...
        // c2s
        registrar.playToServer(ToggleSlimeModeC2SPacket.ID, ToggleSlimeModeC2SPacket.STREAM_CODEC, ToggleSlimeModeC2SPacket::handle);
        registrar.playToServer(SetSlimeUuidC2SPacket.ID, SetSlimeUuidC2SPacket.STREAM_CODEC, SetSlimeUuidC2SPacket::handle);
        registrar.playToServer(SlimeStateC2SPacket.ID, SlimeStateC2SPacket.STREAM_CODEC, SlimeStateC2SPacket::handle);

        // s2c
        registrar.playToClient(SlimeUseCountS2CPacket.ID, SlimeUseCountS2CPacket.STREAM_CODEC, SlimeUseCountS2CPacket::handle);
    }
