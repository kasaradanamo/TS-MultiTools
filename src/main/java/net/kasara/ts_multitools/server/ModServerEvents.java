...
import net.kasara.ts_multitools.server.handler.SlimeAttackHandler;
...
/**
 * サーバー側で発生するイベントや、クライアントから受信後のサーバー処理をまとめて管理する
 */
public class ModServerEvents {
    ...
    public static void registerEvents() {
        ...
        AttackEntityCallback.EVENT.register((player, world, hand, entity, hitResult) -> {
            ...
            // 攻撃した際常にswordになるように
            if (world.isClient()) stack.set(ModComponents.SLIME_STATE, "sword");
