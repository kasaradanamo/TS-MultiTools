...
public class PedestalRenderRegistry {
    ...
    public static void register() {
        ...
        TokorotenSlimeClientAPI.registerPedestalTransformer(ModItems.SLIME.get(), PedestalRenderRegistry::transformSlimeRender);
    ...
    private static ItemStack transformSlimeRender(ItemStack original) {
        ...
        copy.set(ModComponents.SLIME_STATE.get(), SlimeState.SWORD);
        return copy;
    }
}
